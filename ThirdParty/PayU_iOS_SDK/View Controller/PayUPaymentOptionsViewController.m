...
//        hashStr = [Utils createCheckSumString:inputStr];
        ...
        self.hashKey = hashStr;
        [self.parameterDict setObject:hashStr forKey:PARAM_HASH];
    }
...
#warning remove
            ...
            if (_allPaymentOption.count > 0 && !_allPaymentOption[RESPONSE_DICT_KEY_1] && !_allPaymentOption[@"msg"]) {
                _allPaymentOption = [NSMutableDictionary dictionaryWithDictionary:@{RESPONSE_DICT_KEY_1 : _allPaymentOption}];
            }
