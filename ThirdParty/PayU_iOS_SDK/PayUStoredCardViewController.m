...
- (void)displayCustomAlert
{
    ...
    customAlertView.backgroundColor = kLightGrayBgColor;
...
-(void) hideShowTableView:(BOOL) aFlag{
    ...
    if(!aFlag){
        ...
        _noCardFoundLbl.textColor = kLightGrayBgColor;
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string
{
    //NSString *cvv = nil;
    int cvvlength;
    cvvlength = (int)(string.length+textField.text.length-range.length);//+range.location;
