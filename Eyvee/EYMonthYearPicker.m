...
@protocol EYMonthYearPickerViewDelegate
- (void)didSelectDate;
@end
...
@interface EYMonthYearPickerView : UIPickerView <UIPickerViewDataSource, UIPickerViewDelegate>
...
@property (nonatomic,assign) id<EYMonthYearPickerViewDelegate> pickerDelegate;

- (void)setDate:(NSDate *)date animated:(BOOL)animated;

@end

@implementation EYMonthYearPickerView
...
- (void)setDatePickerMode:(EYMonthYearPickerMode)mode {
    datePickerMode = mode;
...
- (void)selectionFromDate:(BOOL)animated {
    ...
    if( datePickerMode == EYMonthYearPickerModeYear ) {
...
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView *)pickerView {
    return (datePickerMode == EYMonthYearPickerModeYear) ? 1 : 2;
}

- (NSInteger)pickerView:(UIPickerView *)pickerView
numberOfRowsInComponent:(NSInteger)component {
    BOOL isYearComponent = (datePickerMode == EYMonthYearPickerModeYear) || (component == 1);
...
@interface EYMonthYearPicker (Delegate) <EYMonthYearPickerViewDelegate>
@end


@implementation EYMonthYearPicker
...
EYMonthYearPickerView *_pickerView;
...
- (id)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        _pickerView = [[EYMonthYearPickerView alloc] initWithFrame:frame];
        [self initCommon];
    }
    return self;
}
...
- (id)initWithCoder:(NSCoder *)aDecoder {
    self = [super initWithCoder:aDecoder];
    if (self) {
        _pickerView = [[EYMonthYearPickerView alloc] initWithCoder:aDecoder];
...
- (EYMonthYearPickerMode)datePickerMode {
    return _pickerView.datePickerMode;
}

- (void)setDatePickerMode:(EYMonthYearPickerMode)dpm {
